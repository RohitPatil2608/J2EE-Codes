...
public class StudentController {
	...
	public ResponseEntity<StudentResponse> searchStudent(@PathVariable int id){
		...
		if (student != null) {
			return new ResponseEntity<StudentResponse>(new StudentResponse("Student data found. ",student, null),HttpStatus.FOUND);
		}
	...
	public ResponseEntity<StudentResponse> searchAllStudents(){
		...
		if (students != null) {
			return new ResponseEntity<StudentResponse>(new StudentResponse("Student details found. ",null, students),HttpStatus.FOUND);
		}
		return new ResponseEntity<StudentResponse>(new StudentResponse("No student data exists. ",null, null),HttpStatus.NOT_FOUND);
	}
