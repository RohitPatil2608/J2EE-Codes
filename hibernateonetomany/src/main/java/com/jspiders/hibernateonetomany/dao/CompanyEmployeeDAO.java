...
public class CompanyEmployeeDAO {
	...
	public static void main(String[] args) {
		try {
			...
			employee2.setId(2);
			employee2.setName("Sita");
			employee2.setEmail("sita@tcs.in");
			...
			employee3.setId(3);
			employee3.setName("Laxman");
			employee3.setEmail("laxman@tcs.in");
			employee3.setDesignation("Tester");
