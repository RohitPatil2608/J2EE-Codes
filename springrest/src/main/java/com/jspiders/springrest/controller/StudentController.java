...
public class StudentController {
	...
	public ResponseEntity<StudentResponse> search(@RequestParam int id) {
		...
		// Failure flow
		return new ResponseEntity<StudentResponse>(new StudentResponse("Data does not exist. ", null, null),
	...
	public ResponseEntity<StudentResponse> searchAllStudents() {
		...
		// Failure flow
		return new ResponseEntity<StudentResponse>(new StudentResponse("No student data found. ", null, null),
				HttpStatus.NOT_FOUND);
	}
}
